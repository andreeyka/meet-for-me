...
//  репозиториев. MEE-420 часть 3 (план MEE-410): группа В — команды записи (К10-К12),
//  поверх частей 1-2 (группы А, Б, Х-К48б, слитых #145). Несколько мелких, дословно
...
//
//  ЧТО НЕ РЕАЛИЗОВАНО ЭТИМ PR, И ПОЧЕМУ ЭТО НЕ НЕДОДЕЛКА. Оставшиеся ~23 метода
//  протокола (группы Г-Ц плана, кроме уже названных сквозных обёрток и группы В) бросают
