...
//
//  Группы А (К1-К10, включая версию MAJOR у К1 и кадр shutdown у К9-Б — MEE-386; К12 — не
//  более одного stdio-запроса в очереди — по-прежнему следующая часть), Б (К11-К14, К61), В (К15-К29,
