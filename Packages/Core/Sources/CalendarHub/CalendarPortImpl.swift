...
//
//  Группы А (К1-К10, кроме версии MAJOR у К1 и кадра shutdown у К9-Б — хост stdio написан,
//  MEE-402 шаг 2, эти два вектора ещё нет, следующая часть MEE-386), Б (К11-К14, К61), В (К15-К29,
