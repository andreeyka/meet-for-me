...
//  ПРАВКИ ПЛАНА ЗДЕСЬ НЕТ НИ ОДНОЙ: область К88 названа Входом критерия, то есть зоной
//  аналитика, а не QA (§1 правил; разбор — дельта `У` плана MEE-288, У.1.2), и потому она
//  названа строкой в отчёте MEE-290, а не внесена рукой исполнителя.
//
