...
//
//  Вторая половина критерия (`.levels` не чаще 10 Гц, значение по формуле) — отдельным файлом,
//  `LevelsTests.swift`: порт публикует `.levels`, троттлинг по времени доставки буфера, не по
//  `hostTime` данных (возврат MEE-317, второй круг).
