...
//  и уезжает в `observedAt`; «сколько сейчас» наблюдение спрашивает у часов Ш6 и решает ими
//  срок подтверждения. Часы момента снимка не подменяют ничем — иначе К51 и К62 сверяли бы
//  одну величину с самой собой. Отсчитывается же срок от `observedAt` прошлой публикации
//  (`ConfirmationPolicy`, инварианты 24 и 25): часам Ш6 принадлежит верхний конец отсчёта,
//  входу Ш4 (ii) — нижний, и обе величины остаются наблюдаемыми врозь.
//
